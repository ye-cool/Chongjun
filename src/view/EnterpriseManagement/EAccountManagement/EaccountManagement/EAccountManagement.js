...
import "./EAccountManagement.css";
import { Col, Row, message, Pagination } from "antd";
import AccountTable from "../../../../component/table/AccountTable/AccountTable";
import { getAccount } from "../../../../apis/company";
class EAccountManagement extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      dataSource: [],
...
export default EAccountManagement;
